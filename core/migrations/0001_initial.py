    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_image', models.ImageField(blank=True, null=True, upload_to=core.models.student_image_path, validators=[core.models.validate_file_size])),
        ...
        migrations.CreateModel(
            name='ExamPaperComponent',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('ASSIGNMENT', 'Assignment'), ('PRESENTATION', 'Presentation'), ('ONPAPER', 'Onpaper')], max_length=20)),
                ('exam_date', models.DateTimeField(help_text='The specific deadline or date/time this component takes place.')),
                ('duration', models.DurationField(help_text="Duration specifically for this part (e.g., '02:00:00' for paper, '00:15:00' for presentation)")),
                ('marks_allocated', models.IntegerField(default=100)),
                ('question_file', models.FileField(blank=True, null=True, upload_to=core.models.component_question_path, validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['pdf', 'doc', 'docx'])])),
                ('exam_paper', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='components', to='core.exampaper')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('component', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='share_links', to='core.exampapercomponent')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('semester', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='semester_subject_links', to='core.semester')),
                ('subject', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='semester_links', to='core.subject')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enrollment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='semester_fees', to='core.enrollment')),
                ('semester', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='school_fees', to='core.semester')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('component', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='results', to='core.exampapercomponent')),
